package ru.eunoia.services.impl;
...
import ru.eunoia.application.out.EmailVerificationRepositoryPort;
import ru.eunoia.application.out.PasswordResetRepositoryPort;
import ru.eunoia.application.out.RefreshTokenRepositoryPort;
import ru.eunoia.application.out.UserServicePort;
import ru.eunoia.domain.exception.AccountLockedException;
import ru.eunoia.domain.exception.AccountNotActiveException;
import ru.eunoia.domain.exception.InvalidCredentialsException;
import ru.eunoia.domain.exception.ServiceUnavailableException;
import ru.eunoia.domain.exception.TokenValidationException;
import ru.eunoia.domain.exception.UserAlreadyExistsException;
import ru.eunoia.domain.exception.UserNotFoundException;
import ru.eunoia.domain.model.AuthEvent;
import ru.eunoia.domain.model.AuthEvent.EventType;
...
import ru.eunoia.services.AuthenticationService;
import org.springframework.transaction.annotation.Transactional;
import ru.eunoia.application.out.PasswordEncoderPort;
