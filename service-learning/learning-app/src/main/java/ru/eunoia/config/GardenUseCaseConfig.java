...
import ru.eunoia.application.garden.service.GrammarMasteryUseCaseImpl;
...
public class GardenUseCaseConfig {
    ...
    @Bean
    public GrammarMasteryUseCase grammarMasteryUseCase(GrammarMasteryRepositoryPort grammarMastery,
                                                       ActivityUseCase activityUseCase) {
        return new GrammarMasteryUseCaseImpl(grammarMastery, activityUseCase);
    }
}
